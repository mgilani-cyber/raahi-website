...
export function Component() {
  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
        ...
        const slides = [
            { title: "Saffron Spice", description: "Saffron Vodka, Ginger Liqueur, Mango Juice — our most celebrated signature.", media: "https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=1600&q=80" },
            { title: "Smokey Trails", description: "Mezcal, Rye, Honey and Cinnamon — smoke meets honey in one unforgettable pour.", media: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=1600&q=80" },
            { title: "Rose Bazaar", description: "Pisco, Elderflower, Sparkling Wine — floral, light and effervescent elegance.", media: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=1600&q=80" },
            { title: "Tableside Theatre", description: "Our Old Fashioned — smoked, whispered, and served tableside every time.", media: "https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=1600&q=80" },
            { title: "Velvet Illusion", description: "Vodka, Coffee Liqueur, Heavy Cream — dark, silky and deeply satisfying.", media: "https://images.unsplash.com/photo-1543007630-9710e4a00a20?w=1600&q=80" },
            { title: "Golden Hour", description: "Daily 4–6 PM · 20% off cocktails · The best hour of the day at Bar Maaya.", media: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1600&q=80" }
        ];
  ...
  return (
    <>
      <main className="slider-wrapper" ref={containerRef as React.RefObject<HTMLElement>}>
